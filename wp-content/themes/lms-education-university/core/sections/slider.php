...
<div class="slider">
  <div class="owl-carousel">
    <?php $lms_education_university_arr_posts = new WP_Query( $args );
    if ( $lms_education_university_arr_posts->have_posts() ) :
      while ( $lms_education_university_arr_posts->have_posts() ) :
        $lms_education_university_arr_posts->the_post();
        ?>
        <div class="blog_box">
          <?php
