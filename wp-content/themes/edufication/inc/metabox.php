...
class Edufication_MetaBox {
    ...
    */
    public function __construct( $meta_box_id, $meta_box_title, $post_type ) {
        ...
        $this->fields = array(
                            'edufication-sidebar-position',
                            'edufication-selected-sidebar',
                            );
    ...
    */
    public function show() {
        ...
        $layout_options         = edufication_sidebar_position();
        $sidebar_options        = edufication_selected_sidebar();
        
        
        // Use nonce for verification  
        wp_nonce_field( basename( __FILE__ ), 'edufication_custom_meta_box_nonce' );

        // Begin the field table and loop  ?>  
        <div id="edufication-ui-tabs" class="ui-tabs">
            <ul class="edufication-ui-tabs-nav" id="edufication-ui-tabs-nav">
                <li><a href="#frag1"><?php esc_html_e( 'Layout Options', 'edufication' ); ?></a></li>
                <li><a href="#frag2"><?php esc_html_e( 'Select Sidebar', 'edufication' ); ?></a></li>
            </ul> 
            ...
            <div id="frag1" class="catch_ad_tabhead">
                <table id="layout-options" class="form-table" width="100%">
                    <tbody>
                        <tr>
                            <?php  
                                $metalayout = get_post_meta( $post->ID, 'edufication-sidebar-position', true );
                                if( empty( $metalayout ) ){
                                    $metalayout='';
                                }
                                ...
                                foreach ( $layout_options as $value => $url ) :
                                    echo '<label>';
                                    echo '<input type="radio" name="edufication-sidebar-position" value="' . esc_attr( $value ) . '" ' . checked( $metalayout, $value, false ) . ' />';
            ...
            <div id="frag2" class="catch_ad_tabhead">
                <table id="sidebar-metabox" class="form-table" width="100%">
                    <tbody> 
                        <tr>
                            <?php
                            $metasidebar = get_post_meta( $post->ID, 'edufication-selected-sidebar', true );
                            ...
                            ?>
                                <td style="vertical-align: top;">
                                    <label class="description">
                                        <input type="radio" name="edufication-selected-sidebar" value="<?php echo esc_attr( $field ); ?>" <?php checked( $field, $metasidebar ); ?>/>&nbsp;&nbsp;<?php echo esc_html( $value ); ?>
                                    </label>
                                </td>
