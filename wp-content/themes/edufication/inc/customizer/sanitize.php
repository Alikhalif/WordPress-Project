...
if ( ! function_exists( 'edufication_sanitize_select' ) ) :
	/**
	 ...
	 */
	function edufication_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'edufication_sanitize_image' ) ) :
	/**
	 ...
	 */
	function edufication_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'edufication_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function edufication_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'edufication_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Edufication 1.0.0
	*/
	function edufication_sanitize_page( $input ) {
...
if ( ! function_exists( 'edufication_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Edufication 1.0.0
	 ...
	 */
	function edufication_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'edufication_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Edufication 1.0.0
	 */
	function edufication_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if( ! function_exists( 'edufication_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Edufication 1.0.0
	 */
	function edufication_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'edufication_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function edufication_santize_allow_tag( $input ) {
 ...
 * @return boolean    
 */
function edufication_sanitize_switch_control( $input ) {
