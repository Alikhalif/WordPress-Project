 ...
 */
if ( ! function_exists( 'edufication_add_testimonial_section' ) ) :
    /**
    * Add testimonial section
    *
    *@since Edufication 1.0.0
    */
    function edufication_add_testimonial_section() {
        ...
        $section_details = apply_filters( 'edufication_filter_testimonial_section_details', $section_details );
        ...
        edufication_render_testimonial_section( $section_details );
    }
endif;

if ( ! function_exists( 'edufication_get_testimonial_section_details' ) ) :
    /**
    ...
    */
    function edufication_get_testimonial_section_details( $input ) {
        $options = edufication_get_theme_options();
...
add_filter( 'edufication_filter_testimonial_section_details', 'edufication_get_testimonial_section_details' );


if ( ! function_exists( 'edufication_render_testimonial_section' ) ) :
  /**
   ...
   *
   */
   function edufication_render_testimonial_section( $content_details = array() ) {
        $options = edufication_get_theme_options();
            ...
            <div id="clients-section">
                <div class="wrapper">
                    ...
                    <div class="section-content">
                        <div class="clients-slider" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "infinite": false, "speed": 800, "dots": false, "arrows":true, "autoplay": true, "draggable": true, "fade": false }'>
